...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AgreementCodeNotFoundException.class)
    public ResponseEntity<ResponsePayload> customerNotFoundExceptionHandler(AgreementCodeNotFoundException e) {
